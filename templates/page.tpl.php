...
<?php endif; ?>
<!-- /#admin-shortcuts -->
<?php if ($logo || $site_name || $site_slogan || ($page['header_left']) || ($page['header_right'])): ?>
<div id="header" class="clearfix header" role="banner">
  <div class="container">
    <div class="row">
      <div id="header-left" class="<?php if ($page['header_right']): print 'span6'; else: print 'span12'; endif; ?>">
        <?php if ($logo): ?>
        ...
        <div id="header-left-content" class="row-fluid header-content"><?php print render($page['header_left']); ?></div>
        <!-- /#header-left-content -->
        <?php endif; ?>
      </div>
      <!-- /#header-left -->

      <div id="header-right" class="<?php if (!$page['header_left']): print 'offset6'; endif; ?> span6">
        <?php if ($page['header_right']): ?>
        <div id="header-right-content" class="row-fluid header-content"><?php print render($page['header_right']); ?></div>
